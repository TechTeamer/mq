...
class RPCClient {
    ...
    constructor(queueConnection, logger, rpcName, options = {}) {
        const { queueMaxSize, timeoutMs, RequestMessageModel = QueueMessage, ResponseMessageModel = QueueMessage, RequestContentSchema = JSON, ResponseContentSchema = JSON, replyQueueName = '', assertReplyQueue = true, assertReplyQueueOptions = {}, bindDirectExchangeName = null, exchangeOptions = {} } = options;
